...
namespace ProductReviewManagement
{
    class Management
    {
        ...
        {
            var recordedData = from productReviews in listProductReview
                               where (productReviews.ProducID == 1 || productReviews.ProducID == 4 || productReviews.ProducID == 9) && productReviews.Rating > 3
        ...
        public void RetrieveCountOdRecords(List<ProductReview> listProductReview)
        {
